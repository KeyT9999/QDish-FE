import { BarChart3, ChefHat, Info, ShieldCheck, Sparkles, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
      <div
        ...
        className="relative flex flex-col space-y-5 overflow-hidden rounded-3xl p-6 lg:col-span-2"
      >
      ...
      <div className="relative flex flex-col justify-between space-y-4 overflow-hidden rounded-3xl border border-neutral-100 bg-white p-6 shadow-sm">
