...
export const RestaurantIngredientsTab: React.FC<RestaurantIngredientsTabProps> = ({ restaurantId }) => {
  ...
  const [sourceType, setSourceType] = useState<'all' | 'global' | 'custom'>('all');
    ...
    <div className="space-y-6">
      ...
      {ingredients.length === 0 && !isLoading && (
        <div className="flex flex-col items-center justify-center text-center py-16 px-4 bg-white border border-neutral-150 rounded-3xl shadow-[0_2px_8px_rgba(0,0,0,0.01)] space-y-4">
          <div className="w-16 h-16 rounded-[20px] bg-green-50/50 border border-green-150/40 flex items-center justify-center text-3xl animate-pulse">
            🥦
          </div>
